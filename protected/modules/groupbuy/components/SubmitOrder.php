...
class SubmitOrder extends CWidget
{
 ...
 public function init()
 {
  ...
  $criteria->select='id,title,description,discount_value,retail_price,discount_percentage,discount_value,end_date,tipping_point,max_available,sold_no,deal_price';
