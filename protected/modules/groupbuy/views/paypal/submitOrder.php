...
<tr>	<div class="row">
      ...
      <td> <div id='price'><?php echo $model->getCurrencySymbol($deal->currency_code).$model->L_AMT0; ?> </div>
...
<tr>
        ...
        <td><div id='total'><?php echo $model->getCurrencySymbol($deal->currency_code).$model->L_AMT0; ?></div> 
        </div> 
...
<input type='hidden' id='currency' value="<?php echo $model->getCurrencySymbol($deal->currency_code); ?>" />
...
if(qty=="")
return;
document.getElementById('PaypalOrder_L_QTY0').value=1;
...
document.getElementById('total').innerHTML=currency+(qty*price);
