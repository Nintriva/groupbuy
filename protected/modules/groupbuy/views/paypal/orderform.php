...
<ul>
<li class="title">Deal</li>
<li class="even"><?php echo $model->L_NAME0; ?></li>

</ul>
<ul>
<li class="title">Currency</li>
<li class="even"><?php echo $form->dropDownList($model,'currencyCodeType',$model->getCurrencyCodeOptions()); ?>
                <?php echo $form->error($model,'currencyCodeType'); ?>
</li>
...
// echo $form->error($model,'max_purchase_units'); 

?>
<li class="title">Quantity(max:<?php echo $model->max_purchase_units; ?>)</li>
<li class="even">

                <?php echo $form->textField($model,'L_QTY0',array('value'=>'1','style'=>'height: 10px;font-size:10px;')); ?>
                <?php  //echo $form->error($model,'L_QTY0'); ?>
...
<li class="even"><?php echo "$".$model->L_AMT0; ?></li>
